...
COPY --from=build /work/target/release/eal-leptos-web /usr/local/bin/eal-leptos-web
USER app
...
ENTRYPOINT ["/usr/local/bin/sops-entrypoint.sh", "/usr/local/bin/eal-leptos-web"]
